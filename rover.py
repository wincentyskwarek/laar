...
class Rover():
    ...
    def go(self, angle, speed):
        ...
        self.servo1.ChangeDutyCycle(7.5+angle/2)
        self.servo2.ChangeDutyCycle(7.2+angle/2)
        
        self.servo5.ChangeDutyCycle(7.2-angle/2)
        self.servo6.ChangeDutyCycle(7-angle/2)
